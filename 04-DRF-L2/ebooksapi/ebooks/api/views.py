...
class ReviewCreateAPIView(generics.CreateAPIView):
    ...
    def perform_create(self, serializer):
        ebook_pk = self.kwargs.get("ebook_pk")      #retreiving pk of the ebook
        ebook = get_object_or_404(Ebook, pk=ebook_pk) #checking if id exists or not?
